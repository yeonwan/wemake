  ...
  public: {
    Tables: {
      ...
      gpt_idea_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "gpt_idea_likes_gpt_idea_id_gpt_ideas_gpt_idea_id_fk"
            columns: ["gpt_idea_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "gpt_idea_likes_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
    ...
    Enums: {
      ...
      product_stages: "Idea" | "MVP" | "Beta" | "Launched" | "Scaling"
      role:
        | "Developer"
        | "Designer"
        | "Marketer"
